...
$config['tables']['users_groups']    = 'users2groups';
 ...
 */
$config['join']['users']  = 'user';
$config['join']['groups'] = 'group';
 ...
 */
$config['site_title']                 = "imoby.nl";       // Site Title, example.com
$config['admin_email']                = "admin@imoby.nl"; // Admin Email, admin@example.com
