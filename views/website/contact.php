...
<!--
<div id="banner" style="padding:2px 0">
    <img border="0" alt="" width="100%" src="http://maps.googleapis.com/maps/api/staticmap?center=<?php echo str_replace('#', ' ', $DealerInfo[0]->street); ?>&amp;zoom=10&amp;size=1360x150&amp;maptype=roadmap&amp;" />
</div>-->
<div id="cont_wrapper"> 
