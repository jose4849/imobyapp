...
<script type="text/javascript" src="<?php echo base_url(); ?>assets/crmAssets/js/crm.js?ts=1445341403"></script>
<script type="text/javascript" src="<?php echo base_url(); ?>assets/crmAssets/js/autos.js?ts=1445341403"></script>
<script type="text/javascript" src="<?php echo base_url(); ?>assets/crmAssets/js/facturen.js?ts=1445341403"></script>
        ...
        <div class="main">
            <div class="accordion-car">
             ...
             <td class="remove-bestand" style="text-align:center;" rel="' . $bestand->document_id . '">'
                                    . '<img src="' . BASE . '/assets/crmAssets/images/delete.png" alt="Verwijderen" title="Verwijderen" />
                                                </td>
             </tr>';
                                }
                            }
            ...
            <div class="ui-dialog-buttonpane ui-helper-clearfix">
                <div class="ui-dialog-buttonset">
                    <button type="submit" class="ui-button ui-widget ui-state-default ui-corner-all ui-button-text-only" role="button" aria-disabled="false">
                        <img src="<?php echo base_url(); ?>assets/crmAssets/images/vinkje.png" class="vinkje">
