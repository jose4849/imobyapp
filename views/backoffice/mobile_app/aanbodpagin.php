...
<div id="wrapper">
    ...
    <div id="contentWrapper">
        <div id="breadCrumsBar"><a href="<?php echo base_url('backoffice/webmobiel/homepagina'); ?>" class="breadcrumb">Web en Mobiel</a> > <span class="lastBreadcrumbs"> Aanbodpagina</span></div>
        <div class="grayColumn">
            ...
            <div class="contentBlock">
                <div class="mobile-left-view">
                    ...
                    <iframe height="357" style="overflow:hidden;" width="235" src="<?php echo base_url(); ?>mobile/aanbod/<?php echo $aanbod; ?>">
                    <p>Your browser does not support iframes.</p>
                    </iframe>  
                </div>
                <div class="mobile-right-view">
                    <h3>imoby.nl/<?php echo $aanbod; ?></h3>
                    <p>
                        <span>Pagina actief:</span>
                        <span id="klant_actief" class="checkBoxSlider actief">
                            <button onclick="mobileAppStatus(1)" type="button" class="radioSliderTrue  blackText radioSlider<?php
        if ($aanbodStatus == 1) {
            echo "Active";
        } else {
            echo "Inactive";
        ...
        ?>">aan</button>
                            <button onclick="mobileAppStatus(0)" type="button" class="radioSliderFalse  blackText radioSlider<?php
                                    if ($aanbodStatus == 0) {
                                        echo "Active";
                                    } else {
                                        echo "Inactive";
        ...
        ?>">uit</button><br>
                            <input type="radio" name="actief" class="radioSliderOn actief" value="1" checked="">
                            <input type="radio" name="actief" class="radioSliderOff actief" value="0">
                        </span> 
                        <script>
                            function mobileAppStatus(status){
                                //  alert(status);
                                $.ajax({
                                    url:"<?php echo base_url(); ?>backoffice/webmobiel/updateStatusAanbod",
                                    data:{
                                        stockPageEnabled:status,                                           
                                        id:<?php echo $dealer_id; ?>
                                    },
                                    type:"POST",
                                    datatype: 'json',
        ...
        <div class="grayColumn">
            ...
            <div class="contentBlock">
                <div class="qr-code">
                    <img src="<?php echo base_url(); ?>qr_images/qr.php?w=296&f=6&c=<?php echo $aanbod; ?>&d=http%3A%2F%2Fapp.imoby.nl%2F<?php echo $aanbod; ?>" />
                </div>
                <div class="mobile-right-view">
                    <p>
                    ...
                    <div class="button-left">
                        <a id="qrdown" href="#" class="button addRelatie"><img src="<?= base_url() ?>assets/crmAssets/images/vinkje.png" class="add">Download</a>
                    </div>
                </div>
            </div>
        </div>
...
<!--                    <p style="margin-top: 30px;"> 
        ...
        <div class="grayColumn">
            ...
            <div class="contentBlock">
                <div class="detectie">
                    <h4>Het onderstaande script zorgt ervoor dat bezoekers met een mobiele telefoon de vraag krijgen of ze de mobiele versie 
                        willen bekijken.</h4>
                    <h4>Plaats het onderstaande script in de head van uw homepage of website.</h4>
                    <textarea rows="4" cols="50"><script type="text/javascript" src="http://app.imoby.nl/base/mobilescript/<?php echo $aanbod; ?>/imoby.js"></script>
                    </textarea> 
                </div>
...
google.load("visualization", "1", { 
    ...
    $( document ).ready(function() {
        ...
        $("#drop").change(function () {
            var value=$( "#drop" ).val();
            console.log(value);
            if(value==1){ location.href=("<?php echo base_url(); ?>backoffice/webmobiel/aanbodpagina/1"); }
            if(value==2){ location.href=("<?php echo base_url(); ?>backoffice/webmobiel/aanbodpagina/3"); }
            if(value==3){ location.href=("<?php echo base_url(); ?>backoffice/webmobiel/aanbodpagina/2"); }         
        ...
        $("#qrformat").change(function () {
            ...
            var url = "<?php echo base_url(); ?>backoffice/webmobiel/qrimage/"+qrsize+"/<?php echo $aanbod; ?>/"+qrformat;
