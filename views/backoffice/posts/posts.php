...
<div id="wrapper">
    ...
    <div id="contentWrapper">
        ...
        <div class="grayColumn">
            <div style="text-indent:20px" class="titleBar3">Postvak IN</div>
            <div class="blue-bar">
                <ul>
                    <li>
                    ...
                    <li><a href="<?php echo base_url(); ?>backoffice/berichten/nieuw">Nieuw</a></li>|
                ...
                <div class="contant-white">
                    ...
                    <div class="contant-white-bottom">
                        ...
                        <div class="page-nav">
                            ...
                            <?php } echo $links; ?>
                            <!--<ul>
                                <li>Pagina <?php echo $cur_pag; ?></li>
                                <li><a class="prev" href="<?php echo $prev_link; ?>">Prev</a></li>
                                <li><a class="next" href="<?php echo $next_link; ?>">Next</a></li>
                            </ul>-->
                        </div>
                    </div>
                </div>	
...
<script>
    ...
    function move_delete(){
        ...
        $.ajax({
            type: 'POST',                   
            url: "<?php echo base_url(); ?>backoffice/berichten/emailmove",
            data: {check_ids:ary,box:'debox'},
